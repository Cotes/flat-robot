...
// const url: string = 'https://api.fotocasa.es/PropertySearch/Search?combinedLocationIds=724,9,8,232,376,8019,0,1146,0&culture=es-ES&hrefLangCultures=ca-ES%3Bes-ES%3Bde-DE%3Ben-GB&isNewConstruction=false&isMap=false&latitude=41.3854&longitude=2.17754&maxPrice=325000&minRooms=2&minSurface=60&pageNumber=1&platformId=1&propertySubtypeIds=6&propertyTypeId=2&sortOrderDesc=true&sortType=bumpdate&transactionTypeId=1';
...
export class AppController {
  ...
  async root(): string {
    ...
    // -H 'origin: https://www.fotocasa.es'
    // -H 'accept-encoding: gzip, deflate, br'
    // -H 'accept-language: en-GB,en-US;q=0.9,en;q=0.8'
    // -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36'
